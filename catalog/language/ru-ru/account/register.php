...
$_['text_wholesale_details'] = 'Данные организации';
$_['entry_company'] = 'Название компании';
$_['entry_inn'] = 'ИНН';
$_['help_dadata_company'] = 'Начните вводить название, ИНН или адрес — подсказки подгружаются из DaData.';
$_['error_company'] = 'Укажите название компании (от 1 до 255 символов)!';
$_['error_inn'] = 'ИНН должен содержать 10 цифр (организация) или 12 цифр (ИП)!';
...
$_['error_email_domain'] = 'Регистрация доступна только для адресов в домене .ru!';
$_['error_telephone'] = 'Номер телефона должен содержать ровно 11 цифр!';
