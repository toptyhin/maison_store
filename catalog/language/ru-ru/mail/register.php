...
$_['text_subject_wholesale'] = '%s - Регистрация оптового покупателя';
$_['text_wholesale_welcome'] = 'Вы зарегистрировались как оптовый покупатель. В скором времени менеджер проверит вашу заявку.';
