...
class ControllerCheckoutGuest extends Controller {
	public function index() {
		...
		$maison = !empty($this->request->get['maison']);
		$logged = $this->customer->isLogged();

		if ($maison && $logged) {
			$fn = isset($this->session->data['payment_address']['firstname']) ? $this->session->data['payment_address']['firstname'] : '';
			$ln = isset($this->session->data['payment_address']['lastname']) ? $this->session->data['payment_address']['lastname'] : '';
			$data['firstname'] = trim($fn . ' ' . $ln);
			$data['lastname'] = $ln;
			$this->load->model('account/customer');
			$customer_info = $this->model_account_customer->getCustomer($this->customer->getId());
			$data['email'] = $customer_info ? $customer_info['email'] : '';
		...
		$template = !empty($this->request->get['maison']) ? 'checkout/guest_maison' : 'checkout/guest';
	...
	public function save() {
		...
		$maison = !empty($this->request->post['maison']);
