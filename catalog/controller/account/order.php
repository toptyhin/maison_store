		...
		if ($order_info) {
			...
			foreach ($products as $product) {
				...
				if ($product_info) {
					...
					$image = $product_info['image'] ? $this->model_tool_image->resize($product_info['image'], 128, 128) : $this->model_tool_image->resize('placeholder.png', 128, 128);
					$href = $this->url->link('product/product', 'product_id=' . $product['product_id'], true);
				} else {
					$reorder = '';
					$image = $this->model_tool_image->resize('placeholder.png', 128, 128);
					$href = '';
				}
