	...
	protected function getForm() {
		...
		if (isset($this->request->post['config_secure'])) {
			...
			$data['config_secure'] = '';
						...
						} elseif (isset($store_info['config_product_delivery_info'])) {
							$data['config_product_delivery_info'] = $store_info['config_product_delivery_info'];
						} else {
						...
						} elseif (isset($store_info['config_product_return_info'])) {
							$data['config_product_return_info'] = $store_info['config_product_return_info'];
						} else {
