...
class ControllerExtensionPaymentCardPayment extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['payment_card_payment_order_status_id'])) {
			$data['payment_card_payment_order_status_id'] = $this->request->post['payment_card_payment_order_status_id'];
		} else {
			$data['payment_card_payment_order_status_id'] = $this->config->get('payment_card_payment_order_status_id');
		}
