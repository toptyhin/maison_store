...
$_['error_filename']        = 'Имя файла (до .ocmod.xml) должно совпадать с тем, что указано в теге code текущего модификатора!';
$_['error_file']          	= 'Файл не найден!';
$_['error_name']          	= 'Не заполнен тег name!';
$_['error_name_exists']     = 'Такое значение тега name уже используется!';
$_['error_code']          	= 'Не заполнен тег code!';
$_['error_code_exists']     = 'Такое значение тега code уже используется!';
$_['error_version']         = 'Не заполнен тег version!';
$_['error_exists']          = 'Модификатор %s уже использует уникальный ID код который вы пытаетесь загрузить!';
$_['error_syntaxis']        = 'Ошибка в синтаксисе файла!';
$_['error_id_not_found']    = 'Модификатор с таким Id не найден!';
