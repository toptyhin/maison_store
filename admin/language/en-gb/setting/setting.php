...
$_['text_telegram_alert'] = 'Telegram Alerts';
$_['text_telegram_instructions'] = '<div class="alert alert-info" style="margin-bottom:15px;"><p><strong>1. Create a bot and copy the token</strong></p><p>In Telegram open @BotFather → /newbot (or use an existing bot).</p><p>Copy the token like <code>123456789:AAH...</code> and paste it into the <strong>Telegram bot token</strong> field below.</p><p><strong>2. Find the chat ID (where to send)</strong></p><p><strong>Direct messages to you:</strong></p><ul><li>Open your bot by name from BotFather and tap <strong>Start</strong> (/start) — otherwise the bot often cannot message you first.</li><li>Get your numeric ID (e.g. via @userinfobot or @getidsbot) and paste it into the <strong>Telegram chat IDs</strong> field.</li></ul><p><strong>Group:</strong></p><ul><li>Add the bot to the group (you can turn off &quot;reads all messages&quot; if you do not need it).</li><li>Get the group ID (usually negative, e.g. <code>-100...</code>) via @getidsbot / forward a group message to @RawDataBot, etc.</li><li>Enter that ID in <strong>Telegram chat IDs</strong> (multiple IDs: comma or newline separated).</li></ul><p class="help-block" style="margin-bottom:0;">Only the Bot API <code>sendMessage</code> is used: webhooks, commands and bot menu are optional.</p></div>';
...
$_['entry_telegram_alert'] = 'Telegram notifications';
$_['entry_telegram_bot_token'] = 'Telegram bot token';
$_['entry_telegram_chat_ids'] = 'Telegram chat IDs';
...
$_['help_telegram_alert'] = 'Same events as mail alerts, sent to Telegram when bot token and chat IDs are set.';
$_['help_telegram_bot_token'] = 'Create a bot with @BotFather and paste the token here.';
$_['help_telegram_chat_ids'] = 'Numeric chat or group IDs, one per line or comma-separated. User ID from @userinfobot; for groups add the bot and use the group ID.';
...
$_['text_test_mail_legend'] = 'Mail send test';
$_['entry_test_mail_to'] = 'Send test to e-mail';
$_['button_test_mail'] = 'Send test e-mail';
$_['text_test_mail_success'] = 'Test message sent (if no SMTP errors were reported, delivery still depends on the recipient server).';
$_['text_test_mail_failed'] = 'Failed to send test e-mail.';
$_['text_test_mail_sent'] = 'Send completed with no PHP warnings.';
$_['text_test_mail_subject'] = '[%s] Mail test %s';
$_['text_test_mail_body'] = "This is a test message from the admin panel.\n\nTime: %s\nHost: %s\n";
$_['error_test_mail_email'] = 'Please enter a valid recipient e-mail.';
$_['error_test_mail_from'] = 'Please set a valid store E-Mail (General tab).';