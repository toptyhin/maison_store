...
$_['entry_wholesale_customer_group'] = 'Wholesale (opt) registration group';
...
$_['help_wholesale_customer_group'] = 'New accounts that register as wholesale (opt) are assigned to this group. Leave as None to keep the same behaviour as retail (default group or customer\'s choice from displayed groups).';
